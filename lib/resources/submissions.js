...
module.exports = (service, endpoint) => {
  ...
  service.post('/projects/:projectId/forms/:formId/submissions', endpoint(({ Audit, Form, SubmissionPartial }, { params, body, auth }) =>
    Promise.all([
  ...
  const csvzip = ({ ClientAudit, Form, Key, SubmissionAttachment, SubmissionDef },
  ...
  service.post(
    '/projects/:projectId/forms/:formId/submissions/:instanceId/attachments/:name',
    endpoint(({ Audit, Blob, ClientAudit, Form, SubmissionAttachment, SubmissionDef }, { params, headers, auth }, request) =>
      Promise.all([
        Form.getByProjectAndXmlFormId(params.projectId, params.formId)
          .then(getOrNotFound)
