...
// takes a buffer and writes it back to a stream that is returned.
const streamFromBuffer = (buf) => {
...
module.exports = { mapStream, mapStreamToPromises, consumeAndBuffer, passthroughAndBuffer, streamFromBuffer, splitStream };
