...
const problems = {
  ...
  internal: {
    ...
    xlsformNotAvailable: problem(501.3, () => 'This ODK Central has not been configured to allow XLSForm conversion. Please upload an XForms XML file (try XLSForm Online) or contact your server administrator.')
  }
};
